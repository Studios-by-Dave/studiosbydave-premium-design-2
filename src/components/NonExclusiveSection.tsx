        ...
        <div className="text-center max-w-4xl mx-auto">
          <div className="flex justify-center mb-2">
            <div className="relative">
              <div className="text-2xl font-bold text-black transform -rotate-2" style={{ fontFamily: 'Comic Sans MS, cursive, sans-serif', textShadow: '2px 2px 0px rgba(0,0,0,0.1)', position: 'relative', display: 'inline-block' }}>
                Click Here!
          ...
          <div className="flex justify-center mb-8">
            <Link to="/about">
              <Button size="lg" className="text-3xl px-20 py-10 bg-primary hover:bg-primary/90 text-primary-foreground font-bold shadow-2xl shadow-primary/50 hover:shadow-primary/70 transition-all duration-300 hover:scale-105 border-4 border-primary/30 group">
