    ...
    <div className="min-h-screen">
      ...
      <section className="py-24 bg-gradient-subtle" itemScope itemType="https://schema.org/ItemList">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-center text-foreground mb-4" itemProp="name">
            Web Design Packages for Spartanburg Businesses
          </h2>
          <p className="text-xl text-muted-foreground text-center max-w-2xl mx-auto mb-16">
            Choose the perfect package for your Spartanburg business needs
          </p>
      ...
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-muted-foreground text-center mb-8">Serving businesses throughout Spartanburg and the Upstate region</p>
      ...
      <section className="py-16 bg-gradient-subtle">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-foreground mb-4">Ready to Grow Your Spartanburg Business Online?</h2>
