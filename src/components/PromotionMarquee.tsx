...
const PromotionMarquee = () => {
  return <div className="w-[95%] mx-auto bg-[linear-gradient(110deg,hsl(0_0%_75%)_0%,hsl(0_0%_90%)_25%,hsl(0_0%_95%)_50%,hsl(0_0%_90%)_75%,hsl(0_0%_75%)_100%)] py-2 overflow-hidden relative">
