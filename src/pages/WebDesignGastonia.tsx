...
const WebDesignGastonia = () => {
  const breadcrumbs = breadcrumbSchema([
    { name: "Home", url: "https://www.studiosbydave.com" },
    { name: "Web Design Gastonia", url: "https://www.studiosbydave.com/web-design-gastonia-nc" }
  ]);

  const gastoniaWebDesignSchema = serviceSchema(
    "Professional Web Design Gastonia NC",
    "Custom responsive websites designed specifically for Gastonia businesses including contractors, manufacturing, retail, and professional services with mobile-first design and SEO optimization.",
    "https://www.studiosbydave.com/web-design-gastonia-nc"
  );

  const gastoniaLocalSchema = localServiceSchema(
    "Web Design Services Gastonia NC",
    "Local web design services in Gastonia, NC. We create custom websites for Gastonia businesses including contractors, manufacturing, retail, and professional services.",
    "https://www.studiosbydave.com/web-design-gastonia-nc"
  );
  ...
  return (
    <div className="min-h-screen bg-luxury-bg">
      <SimpleSEO
        title="Web Design Gastonia NC | Professional Websites for Local Businesses"
        description="Custom web design services in Gastonia, NC. We build mobile-responsive websites that convert visitors into customers for contractors, manufacturing, retail, and professional services. Get your free quote today."
        keywords="web design Gastonia NC, Gastonia web development, Gastonia website design, Gastonia small business websites, Gastonia contractor websites, Gastonia SEO, Gastonia digital marketing"
        structuredData={[breadcrumbs, gastoniaWebDesignSchema, gastoniaLocalSchema, webDesignFAQSchema, ...webPackageOfferSchema, ...googleReviewsSchema]}
      />
      <Navigation />
      ...
      <section className="relative min-h-[70vh] bg-luxury-bg noise-overlay flex items-center" itemScope itemType="https://schema.org/WebPageElement">
        {/* Gastonia Downtown Background */}
        <div
          className="absolute inset-0 z-0"
          style={{
            backgroundImage: 'url("/assets/Gastonia-JAN2020-downtown-1140x605.png")',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-20 py-24">
          <div className="relative inline-block">
            <div className="section-eyebrow mb-4">✦ Gastonia, NC</div>
          ...
          <p className="font-body text-luxury-text-secondary text-xl max-w-3xl mx-auto mb-10" itemProp="description">
            Professional web design for Gastonia businesses. We create custom websites that turn visitors into paying customers—serving Gastonia and the greater Charlotte metro area.
          </p>
      ...
      <section className="py-32 bg-luxury-surface border-y border-white/6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="display-heading text-luxury-text-primary text-4xl text-center mb-12">
            Serving Gastonia's Growing Business Community
          </h2>
          <p className="font-body text-luxury-text-secondary text-lg max-w-4xl mx-auto mb-16 leading-relaxed text-center">
            Gastonia is the largest city in Gaston County and a key part of the Charlotte metropolitan area. From manufacturing to retail to professional services, we understand the unique challenges Gastonia businesses face. Our web design services are tailored to help Gastonia businesses compete in the digital marketplace.
          </p>
            ...
            {[
              {
                ...
                description: "Professional websites for manufacturing companies, industrial services, and logistics businesses in Gastonia's industrial sector.",
                industries: ["Manufacturing", "Industrial Services", "Logistics", "Distribution"]
              },
              {
                title: "Downtown & Retail",
                description: "Creative web solutions for retail shops, restaurants, and local businesses in downtown Gastonia and shopping districts.",
                industries: ["Retail Stores", "Restaurants", "Local Shops", "Service Businesses"]
              },
              {
                title: "Contractors & Home Services",
                description: "Comprehensive web design for contractors, home services, and trades throughout Gastonia County.",
                industries: ["Contractors", "Home Services", "Trades", "Construction"]
              }
            ].map((area, index) => (
      ...
      <section className="py-32 bg-luxury-bg" itemScope itemType="https://schema.org/ItemList">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="display-heading text-luxury-text-primary text-4xl text-center mb-16" itemProp="name">
            Everything Your Gastonia Business Website Needs
          </h2>
            ...
            {[
              {
                ...
                description: "Gastonia customers search on mobile—we ensure your site looks perfect on all devices",
              ...
              },
              {
                ...
                description: "Optimized for speed to keep Gastonia visitors engaged and reduce bounce rates",
              ...
              },
              {
                icon: Search,
                title: "Gastonia SEO",
                description: "Local SEO optimized for Gastonia search results and Google Business Profile",
                features: ["On-Page SEO", "Technical SEO", "Local Gastonia SEO", "Rankings Boost"],
                backdrop: googleBackdrop
              },
              {
                icon: Globe,
                title: "Lead Generation",
                description: "Contact forms and CTAs designed to convert Gastonia visitors into customers",
      ...
      <section className="py-32 bg-luxury-surface border-y border-white/6" itemScope itemType="https://schema.org/ItemList">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="display-heading text-luxury-text-primary text-4xl text-center mb-4" itemProp="name">
            Web Design Packages for Gastonia Businesses
          </h2>
          <p className="font-body text-luxury-text-secondary text-xl text-center max-w-2xl mx-auto mb-16">
            Choose the perfect package for your Gastonia business needs
          </p>
      ...
      <section className="py-32 bg-luxury-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="font-body text-luxury-text-secondary text-lg text-center mb-8">Serving businesses throughout Gastonia and Gaston County</p>
      ...
      <section className="py-32 bg-luxury-surface border-y border-white/6">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="display-heading text-luxury-text-primary text-3xl mb-4">Ready to Grow Your Gastonia Business Online?</h2>
          <p className="font-body text-luxury-text-secondary text-lg mb-8">
            Contact us today for a free consultation and discover how we can help your Gastonia business succeed online.
          </p>
          <Link to="/contact#get-in-touch">
...
export default WebDesignGastonia;
