...
const WebDesignAsheville = () => {
  const breadcrumbs = breadcrumbSchema([
    { name: "Home", url: "https://www.studiosbydave.com" },
    { name: "Web Design Asheville", url: "https://www.studiosbydave.com/web-design-asheville-nc" }
  ]);

  const ashevilleWebDesignSchema = serviceSchema(
    "Professional Web Design Asheville NC",
    "Custom responsive websites designed specifically for Asheville businesses including tourism, hospitality, arts, and professional services with mobile-first design and SEO optimization.",
    "https://www.studiosbydave.com/web-design-asheville-nc"
  );

  const ashevilleLocalSchema = localServiceSchema(
    "Web Design Services Asheville NC",
    "Local web design services in Asheville, NC. We create custom websites for Asheville businesses including tourism, hospitality, arts, and professional services.",
    "https://www.studiosbydave.com/web-design-asheville-nc"
  );
  ...
  return (
    <div className="min-h-screen bg-luxury-bg">
      <SimpleSEO
        title="Web Design Asheville NC | Professional Websites for Local Businesses"
        description="Custom web design services in Asheville, NC. We build mobile-responsive websites that convert visitors into customers for tourism, hospitality, arts, and professional services. Get your free quote today."
        keywords="web design Asheville NC, Asheville web development, Asheville website design, Asheville small business websites, Asheville tourism websites, Asheville SEO, Asheville digital marketing"
        structuredData={[breadcrumbs, ashevilleWebDesignSchema, ashevilleLocalSchema, webDesignFAQSchema, ...webPackageOfferSchema, ...googleReviewsSchema]}
      />
      <Navigation />
      ...
      <section className="relative min-h-[70vh] bg-luxury-bg noise-overlay flex items-center" itemScope itemType="https://schema.org/WebPageElement">
        {/* Asheville Downtown Background */}
        <div
          className="absolute inset-0 z-0"
          style={{
            backgroundImage: 'url("/assets/Asheville-Downtown-at-Sunset-1536x1032-2.webp")',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-20 py-24">
          <div className="relative inline-block">
            <div className="section-eyebrow mb-4">✦ Asheville, NC</div>
          ...
          <p className="font-body text-luxury-text-secondary text-xl max-w-3xl mx-auto mb-10" itemProp="description">
            Professional web design for Asheville businesses. We create custom websites that turn visitors into paying customers—serving Asheville and Western North Carolina.
          </p>
      ...
      {/* Asheville Market Focus Section */}
      <section className="py-32 bg-luxury-surface border-y border-white/6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="display-heading text-luxury-text-primary text-4xl text-center mb-12">
            Serving Asheville's Unique Business Community
          </h2>
          <p className="font-body text-luxury-text-secondary text-lg max-w-4xl mx-auto mb-16 leading-relaxed text-center">
            Asheville is known for its vibrant arts scene, thriving tourism industry, and innovative small businesses. From the River Arts District to Biltmore Village, we understand the unique challenges Asheville businesses face. Our web design services are tailored to help Asheville businesses stand out in this creative and competitive market.
          </p>
            ...
            {[
              {
                ...
                description: "Professional websites for hotels, restaurants, breweries, and tourism businesses in Asheville's thriving visitor economy.",
                industries: ["Hotels & Lodging", "Restaurants", "Breweries", "Tourism Services"]
              },
              {
                title: "Arts & Creative",
                description: "Creative web solutions for artists, galleries, studios, and creative businesses throughout Asheville's arts community.",
                industries: ["Artists", "Galleries", "Creative Studios", "Artisan Shops"]
              },
              {
                title: "Professional Services",
                description: "Comprehensive web design for healthcare, legal, financial, and professional services in Western North Carolina.",
                industries: ["Healthcare", "Legal Services", "Financial Services", "Consulting"]
              }
            ].map((area, index) => (
      ...
      <section className="py-32 bg-luxury-bg" itemScope itemType="https://schema.org/ItemList">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="display-heading text-luxury-text-primary text-4xl text-center mb-16" itemProp="name">
            Everything Your Asheville Business Website Needs
          </h2>
            ...
            {[
              {
                ...
                description: "Asheville tourists search on mobile—we ensure your site looks perfect on all devices",
              ...
              },
              {
                ...
                description: "Optimized for speed to keep Asheville visitors engaged and reduce bounce rates",
              ...
              },
              {
                icon: Search,
                title: "Asheville SEO",
                description: "Local SEO optimized for Asheville search results and Google Business Profile",
                features: ["On-Page SEO", "Technical SEO", "Local Asheville SEO", "Rankings Boost"],
                backdrop: googleBackdrop
              },
              {
                icon: Globe,
                title: "Lead Generation",
                description: "Contact forms and CTAs designed to convert Asheville visitors into customers",
      ...
      <section className="py-32 bg-luxury-surface border-y border-white/6" itemScope itemType="https://schema.org/ItemList">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="display-heading text-luxury-text-primary text-4xl text-center mb-4" itemProp="name">
            Web Design Packages for Asheville Businesses
          </h2>
          <p className="font-body text-luxury-text-secondary text-xl text-center max-w-2xl mx-auto mb-16">
            Choose the perfect package for your Asheville business needs
          </p>
      ...
      <section className="py-32 bg-luxury-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="font-body text-luxury-text-secondary text-lg text-center mb-8">Serving businesses throughout Asheville and Western North Carolina</p>
      ...
      <section className="py-32 bg-luxury-surface border-y border-white/6">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="display-heading text-luxury-text-primary text-3xl mb-4">Ready to Grow Your Asheville Business Online?</h2>
          <p className="font-body text-luxury-text-secondary text-lg mb-8">
            Contact us today for a free consultation and discover how we can help your Asheville business succeed online.
          </p>
          <Link to="/contact#get-in-touch">
...
export default WebDesignAsheville;
