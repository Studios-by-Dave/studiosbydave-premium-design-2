    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-muted-foreground text-center mb-8">Serving businesses throughout Gastonia and Gaston County</p>
      ...
      <section className="py-16 bg-gradient-subtle">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-foreground mb-4">Ready to Grow Your Gastonia Business Online?</h2>
